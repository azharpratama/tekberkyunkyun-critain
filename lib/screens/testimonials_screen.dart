...
const String _PERSON_IMAGE = 'assets/george_widodo_photo.png'; 
const Color _GREEN_COLOR = Color(0xFF5AB664);
const Color _ORANGE_COLOR = Color(0xFFF18E5E);
...
class Testimonial {
  ...
  const Testimonial({required this.quote, required this.name, required this.imagePath});
}

const List<Testimonial> testimonialsData = [
  Testimonial(
    name: 'George J - Widodo',
    quote: 'Selamat, dan Sukses. Lorem ipsum dolor sit amet consectetur. Convallis est urna adipiscing fringilla nulla diam lorem non mauris. Ultrices aliquet at quam adipiscing feugiat interdum mattis.',
    imagePath: _PERSON_IMAGE,
  ),
  Testimonial(
    name: 'George J - Widodo',
    quote: 'Selamat, dan Sukses. Lorem ipsum dolor sit amet consectetur. Convallis est urna adipiscing fringilla nulla diam lorem non mauris. Ultrices aliquet at quam adipiscing feugiat interdum mattis.',
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Opacity(
                    opacity: _currentPage < testimonialsData.length - 1 ? 1.0 : 0.4,
                    child: _buildNavButton(
                      icon: Icons.arrow_forward_ios,
                      onPressed: _currentPage < testimonialsData.length - 1 ? _nextPage : null,
                    ),
                  ),
                ],
              ),
...
Widget _buildNavButton({required IconData icon, VoidCallback? onPressed}) {
  return Container(
    ...
    height: 40,
    decoration: BoxDecoration(
      color: onPressed != null ? _ORANGE_COLOR : _ORANGE_COLOR.withOpacity(0.5),
