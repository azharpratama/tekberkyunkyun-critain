...
class PerpustakaanCerita extends StatelessWidget {
  const PerpustakaanCerita({super.key});
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              Row(
                children: [
                  Icon(Icons.library_books_outlined, color: Colors.grey[800]),
              ...
              Center(
                child: Image.asset(
                  'assets/images/people-icon-pc.png',
                  height: 300,
                  fit: BoxFit.contain,
                ),
              ),
              ...
              const StoryCard(
                ...
                backgroundColor: Color(0xFF3A9D76), // Green color from image
